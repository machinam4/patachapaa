<template>
  <div class="spoiler">
    <div class="spoiler__header" @click="active = !active">
      ...
      <slot name="title">What is this site?</slot>
    ...
    <div ref="body" class="spoiler__body" :style="{ height: bodyHeight }">
      <p class="pb-4">
        <slot name="text"
          >PATACHAPAA - financial games with the withdrawal of real funds.
          Presently The site accept deposites on m-pesa. PATACHAPAA is
          registered Kenya and operating in accordance with all established
          legal regulations.
        </slot>
      </p>
    </div>
